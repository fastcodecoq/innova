...
class tiempo{
	...
	function obt_fecha(){
		return $this->mesn."/".$this->dia."/".$this->anio;
	}
	function obt_anio(){
		return $this->anio;
	}
...
class datos_sql{
	 ...
	 function datos_sql($tabla){
		 ...
		 $this->local=new obj_info_sql("innova","localhost","root","2857811",$tabla);
		 }else{
		 $this->local=new obj_info_sql("castleway","50.63.230.59","castleway","Chester.1612",$tabla);
		 }
	 }
	 function obt_local(){
		 return $this->local;
